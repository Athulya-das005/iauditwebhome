...
import IsoAuditReportBlogContent from "./IsoAuditReportBlogContent";

const pageUrl = "https://www.iaudit.global/blog/how-to-write-an-iso-internal-audit-report-that-matters";
const ogImage = "https://www.iaudit.global/images/blog-auditor-training.webp";
const title = "How to Write an ISO Internal Audit Report That Matters";
const description =
    "Learn how to write an ISO internal audit report with clear structure, objective evidence, findings, corrective actions and common mistakes to avoid now.";
...
const jsonLd = {
    ...
    "@graph": [
            ...
            breadcrumb: {
                ...
                itemListElement: [
                    ...
                    { "@type": "ListItem", position: 2, name: "Blog", item: "https://www.iaudit.global/blog" },
                    {
                        "@type": "ListItem",
                        position: 3,
                        name: "How to Write an ISO Internal Audit Report",
                        item: pageUrl,
                    },
                ],
            },
        },
        {
            ...
            headline: "How to Write an ISO Internal Audit Report That Your Next Auditor Will Appreciate",
            description,
            url: pageUrl,
            inLanguage: "en-GB",
            author: {
...
export default function IsoAuditReportBlogPage() {
    return (
        <>
            <script
