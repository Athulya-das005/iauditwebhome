                    ...
                    <aside style={{ position: "sticky", top: "58px", alignSelf: "start" }}>
                        ...
                        >
                            ...
                            <p style={{ margin: "0 0 1.75rem", fontSize: "0.875rem", color: "#6B7280", lineHeight: 1.7, fontFamily: font }}>
                                Helping manufacturers turn risk-based auditing into structured, evidence-based shop-floor
                                practice.
                            </p>
                            <Link
                                href="/contact"
                ...
                {isMobile && (
                    ...
                    >
                        ...
                        <p style={{ margin: "0 0 1.25rem", fontSize: "0.875rem", color: "#6B7280", lineHeight: 1.7, fontFamily: font }}>
                            Helping manufacturers turn risk-based auditing into structured shop-floor practice.
                        </p>
                        <Link
                            href="/contact"
                            style={{
