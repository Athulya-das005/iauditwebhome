                    ...
                    <div style={{ paddingRight: isMobile ? "0" : "2rem" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "2.5rem" }}>
                            ...
                            >
                                ...
                                <div>
                                    <h4 style={{ fontSize: "1rem", fontWeight: 600, color: "#111827", marginBottom: "0.5rem" }}>Reach Us</h4>
                            ...
                            >
                                ...
                                <div>
                                    <h4 style={{ fontSize: "1rem", fontWeight: 600, color: "#111827", marginBottom: "0.5rem" }}>Call or email us anytime</h4>
