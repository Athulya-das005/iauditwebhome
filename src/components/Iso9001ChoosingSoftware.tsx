...
const criteria = [
    {
        num: "01",
        title: "Choose Purpose-Built Over Generic",
        description:
            "Select a tool designed for ISO audits, not a repurposed project management app.",
        icon: (
    ...
    {
        num: "02",
        title: "Prioritize Full Lifecycle Support",
        description:
            "Your software should manage everything from planning the audit to verifying corrective action effectiveness.",
        icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" style={{ width: "36px", height: "36px" }}>
...
export default function Iso9001ChoosingSoftware() {
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <SectionTag isMobile={isMobile}>Choosing ISO 9001 software</SectionTag>
                    </div>
                    <h2
                        style={{
                            ...aboutType.sectionH2(),
                    ...
                    >
                        How to Choose the Right ISO 9001 Audit Management Software
                    </h2>
                </motion.div>
