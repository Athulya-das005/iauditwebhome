...
const features = [
    {
        num: "01",
        title: "Risk-Based Safety Planning",
        description:
            "Schedule audits based on high-risk activities and site-specific hazards to ensure maximum worker protection.",
    ...
    {
        num: "02",
        title: "Real-Time Hazard Evidence",
        description:
            "Capture on-site photos of PPE, machinery guarding, and site conditions directly against safety audit questions.",
    ...
    {
        num: "03",
        title: "Verified Corrective Actions",
        description:
            "Ensure every safety nonconformity is tracked from identification through to verified closure and root-cause analysis.",
        accent: "light" as const,
        icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" style={{ width: "44px", height: "44px" }}>
...
export default function Iso45001CoreFeatures() {
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        Core Features Your ISO 45001 Software Must Have
                    </h2>
