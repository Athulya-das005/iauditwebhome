...
/* ─── shared box shadow ─────────────────────────────────────────── */
const SHADOW = "0 2px 6px rgba(0,0,0,0.04), 0 12px 48px rgba(0,0,0,0.10)";
...
export default function AboutNew() {
    return (
        ...
        >
                ...
                <div style={{
                    ...
                    >
                        ...
                        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
                            <div style={{ display: "flex", alignItems: "flex-end", gap: "9px", minHeight: "290px" }}>
                                {BARS2.map((h, i) => (
                                    <motion.div
                                        key={i}
                                        initial={{ scaleY: 0 }}
            ...
            ══════════════════════════════════════════════════ */}
            <div style={{ maxWidth: "1240px", margin: "0 auto", padding: "6rem 2rem 5rem" }}>
                ...
                {/* H2 + description */}
                <div style={{ display: "flex", flexDirection: "column", gap: "1rem", marginBottom: "3.5rem", maxWidth: "580px" }}>
                    <motion.h2
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1.2rem" }}>
                    ...
                    >
                        ...
                        <div style={{ padding: "1.4rem 0.2rem 0" }}>
                            <h3 style={{ fontWeight: 700, fontSize: "1.2rem", color: "#0d1117", margin: "0 0 0.6rem" }}>Structured audits and PDCA</h3>
                    ...
                    >
                        ...
                        <div style={{ padding: "1.4rem 0.2rem 0" }}>
                            <h3 style={{ fontWeight: 700, fontSize: "1.2rem", color: "#0d1117", margin: "0 0 0.6rem" }}>Unified audit history</h3>
                            <p style={{ fontSize: "0.95rem", color: "#6b7280", lineHeight: 1.7, margin: "0 0 1rem" }}>
                    ...
                    >
                        ...
                        <div style={{ padding: "1.4rem 0.2rem 0" }}>
                            <h3 style={{ fontWeight: 700, fontSize: "1.2rem", color: "#0d1117", margin: "0 0 0.6rem" }}>From audits to improvement</h3>
                            <p style={{ fontSize: "0.95rem", color: "#6b7280", lineHeight: 1.7, margin: "0 0 1rem" }}>
            ...
            <div style={{
                ...
                <motion.div
                    ...
                    style={{
                        ...
                        boxShadow: "0 2px 6px rgba(0,102,68,0.06), 0 20px 64px rgba(0,102,68,0.14)",
                    }}
                >
            ...
            ══════════════════════════════════════════════════ */}
            <div style={{ background: "#f7f8f9", padding: "7rem 0 7rem" }}>
                <div style={{ maxWidth: "1240px", margin: "0 auto", padding: "0 2rem" }}>
                    ...
                    <motion.p
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.5, delay: 0.14 }}
                        style={{ textAlign: "center", fontSize: "0.97rem", lineHeight: 1.7, color: "#6b7280", maxWidth: "560px", margin: "0 auto 3.5rem" }}
                    >
                    ...
                    {/* ── 3-card grid ── */}
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "1.2rem", alignItems: "stretch" }}>
                        ...
                        <motion.div
                            ...
                            style={{
                                ...
                                borderRadius: "20px",
                                padding: "2rem",
                                boxShadow: "0 2px 6px rgba(0,0,0,0.04), 0 10px 32px rgba(0,0,0,0.07)",
                                display: "flex",
                                flexDirection: "column",
                                gap: "1.5rem",
                            }}
                    ...
                    {/* ── 2-card grid row ── */}
                    <div style={{ display: "grid", gridTemplateColumns: "1.45fr 1fr", gap: "1.2rem", marginTop: "1.2rem" }}>
                        ...
                        >
                            ...
                            <div style={{ flex: "0 0 48%", padding: "2rem", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                                <h3 style={{ fontWeight: 700, fontSize: "1.32rem", color: "#0d1117", margin: "0 0 0.8rem", letterSpacing: "-0.02em" }}>
                                    Clarity over complexity
                                </h3>
                                <p style={{ fontSize: "0.9rem", color: "#6b7280", lineHeight: 1.5, margin: "0 0 1.25rem" }}>
                                    Auditors and auditees see only what they need, with clean workflows across sites and standards.
                                </p>
                            ...
                            {/* Right Visual Mockup (48%) */}
                            <div style={{ flex: 1, background: "#f9fafb", borderLeft: "1px solid #f3f4f6", position: "relative", overflow: "hidden" }}>
                                <div style={{ position: "absolute", top: "1.25rem", left: "1.25rem", right: "-2.5rem", bottom: "-2.5rem", background: "#fff", borderRadius: "10px 0 0 0", borderTop: "1px solid #e5e7eb", borderLeft: "1px solid #e5e7eb", boxShadow: "-15px 15px 40px rgba(0,0,0,0.03)" }}>
                                    {/* Mockup Title Bar */}
                                    <div style={{ padding: "0.75rem 1rem", borderBottom: "1px solid #f3f4f6", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                                        <div style={{ display: "flex", gap: "6px" }}>
                                            ...
                                            <div style={{ width: "18px", height: "8px", borderRadius: "4px", background: "#f3f4f6" }} />
                                        </div>
                                        <div style={{ display: "flex", gap: "8px" }}>
                                            <div style={{ width: "12px", height: "2px", background: "#e5e7eb", borderRadius: "1px" }} />
                                            <div style={{ width: "12px", height: "2px", background: "#e5e7eb", borderRadius: "1px" }} />
                                        </div>
                                    </div>

                                    <div style={{ padding: "1.25rem 1.25rem 1.25rem 2.25rem" }}>
                                        <p style={{ fontSize: "0.8rem", fontWeight: 700, color: "#111827", margin: "0 0 1rem" }}>Welcome to your workspace</p>

                                        {/* Profile Card Container */}
                                        <div style={{ display: "flex", flexDirection: "column", gap: "0.8rem" }}>
                                            {([
                                                { name: "Philips Williams", role: "Audit Lead", color: "60a5fa" },
                                                { name: "Sara Miller", role: "Quality Manager", color: "f87171" }
                                            ]).map((user, i) => (
                                                <motion.div
                                                    key={i}
                                                ...
                                                >
                                                    <div style={{ width: "32px", height: "32px", borderRadius: "50%", overflow: "hidden", border: "1.5px solid #f3f4f6" }}>
                                                        <img src={`https://ui-avatars.com/api/?name=${user.name.replace(' ', '+')}&background=${user.color}&color=fff&bold=true`} alt="avatar" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                                                    </div>
                                                    <div>
                                                        <p style={{ fontSize: "0.72rem", fontWeight: 700, color: "#111827", margin: 0 }}>{user.name}</p>
                                                        <p style={{ fontSize: "0.62rem", color: "#9ca3af", margin: 0 }}>{user.role}</p>
                                                    </div>
                                                </motion.div>
                                            ))}
                                        </div>
                                    ...
                                    {/* Vertical Tag (Left Overlay) */}
                                    <motion.div
                                        initial={{ opacity: 0, scaleY: 0 }}
                                        whileInView={{ opacity: 1, scaleY: 1 }}
                                        viewport={{ once: true }}
                                        transition={{ delay: 0.3, duration: 0.5 }}
                                        style={{ position: "absolute", top: "1.5rem", left: "-0.6rem", width: "30px", height: "180px", background: "#ED6A5A", borderRadius: "8px", display: "flex", flexDirection: "column", alignItems: "center", gap: "1rem", paddingTop: "0.75rem", boxShadow: "3px 0 10px rgba(237,106,90,0.15)", transformOrigin: "top" }}
                                    >
                                        <div style={{ width: "16px", height: "16px", borderRadius: "3px", background: "#14664A", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.6rem", fontWeight: 800, color: "#fff" }}>Z</div>
                                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z" /></svg>
                                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5"><rect x="3" y="4" width="18" height="18" rx="2" ry="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" /></svg>
                                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5"><path d="M12 20h9" /><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z" /></svg>
                                    </motion.div>
                                </div>
                            </div>
                        </motion.div>
            ...
            <section style={{
                ...
                <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 2rem" }}>
                    ...
                    {/* Section Header */}
                    <div style={{ marginBottom: "5rem", maxWidth: "800px", textAlign: "left" }}>
                        <motion.div
                            initial={{ opacity: 0, y: 14 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
