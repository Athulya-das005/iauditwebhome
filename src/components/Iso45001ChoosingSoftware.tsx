...
const criteria = [
    {
        ...
        description:
            "Choose software that works on the floor, allowing auditors to capture live evidence in high-risk environments.",
        icon: (
    ...
    },
    {
        ...
        description:
            "Protect sensitive safety records with a strict zero-access policy, ensuring your data remains strictly private.",
        icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" style={{ width: "36px", height: "36px" }}>
...
export default function Iso45001ChoosingSoftware() {
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <SectionTag isMobile={isMobile}>Choosing ISO 45001 software</SectionTag>
                    </div>
                    <h2
                        style={{
                            ...aboutType.sectionH2(),
                    ...
                    >
                        How to Choose the Right ISO 45001 Audit Management Software
                    </h2>
                </motion.div>
